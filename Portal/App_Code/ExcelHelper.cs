...
/// <summary>
/// Descripción breve de ExcelHelper
/// </summary>
public class ExcelHelper
{
	 ...
	 //Row limits older excel verion per sheet, the row limit for excel 2003 is 65536
        ...
        private static string getWorkbookTemplate()
        {
            ...
            sb.AppendFormat(@"   <Font ss:FontName=""Calibri"" x:Family=""Swiss"" ss:Size=""8"" ss:Color=""#000000""/>{0}", Environment.NewLine);
        ...
        public static void ToExcel(DataSet dsInput, string filename, HttpResponse response)
        {
            ...
            //response.Write("<font style='font-size:8.0pt; font-family:Calibri;'>");
