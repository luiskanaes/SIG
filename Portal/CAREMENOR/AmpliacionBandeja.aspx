<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MasterPopup.master" AutoEventWireup="true" CodeFile="AmpliacionBandeja.aspx.cs" Inherits="CAREMENOR_AmpliacionBandeja" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <asp:ImageButton ID="btncrear" runat="server" ImageUrl="~/imagenes/boton.agregar.gif" OnClick="btncrear_Click"  />
            </div>
        <div class="col-md-4">
            <br />
