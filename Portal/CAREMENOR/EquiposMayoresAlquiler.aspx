<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdminPopup.master" AutoEventWireup="true" CodeFile="EquiposMayoresAlquiler.aspx.cs" Inherits="CAREMENOR_EquiposMayoresAlquiler" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function popup(Requ_Numero, Reqd_CodLinea, Reqs_Correlativo, FLG_MENOR, ancho, alto) {
            ...
            var win_timer = setInterval(function () {
                if (win.closed) {
                  document.getElementById('HdDatoConsulReq').value = Requ_Numero;
                var boton = document.getElementById('<%=btnConsulta.ClientID%>');
                boton.click();
    ...
    function PopupPosicion(Requ_Numero, Reqd_CodLinea, Reqs_Correlativo, ancho, alto) {
        gridviewScroll();
        var posicion_x;
        var posicion_y;
        posicion_x = (screen.width / 2) - (ancho / 2);
        ...
        var win = window.open("RegistroSolped.aspx?Requ_Numero=" + Requ_Numero + "&Reqd_CodLinea=" + Reqd_CodLinea + "&Reqs_Correlativo=" + Reqs_Correlativo, "Page Title", "width=" + ancho + ",height=" + alto + ",menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left=" + posicion_x + ",top=" + posicion_y + "");
        var win_timer = setInterval(function () {
            if (win.closed) {
                document.getElementById('HdDatoConsulReq').value = Requ_Numero;
                var boton = document.getElementById('<%=btnConsulta.ClientID%>');
    ...
    function PopupAmpliacion(ancho, alto) {
        ...
        var win = window.open("AmpliacionControl.aspx", "Page Title", "width=" + ancho + ",height=" + alto + ",menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left=" + posicion_x + ",top=" + posicion_y + "");
        var win_timer = setInterval(function () {
            if (win.closed) {
                 document.getElementById('HdDatoConsulReq').value = Requ_Numero;
                var boton = document.getElementById('<%=btnConsulta.ClientID%>');
        ...
        function popupAsignar(Req, ancho, alto) {
        gridviewScroll();
        var posicion_x;
        var posicion_y;
        posicion_x = (screen.width / 2) - (ancho / 2);
        ...
        var win = window.open("AsignarRequerimiento.aspx?Req=" + Req , "Page Title", "width=" + ancho + ",height=" + alto + ",menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left=" + posicion_x + ",top=" + posicion_y + "");
        var win_timer = setInterval(function () {
            if (win.closed) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel runat="server" ID="Upnl">
        <ContentTemplate>
            <asp:HiddenField ID="HdDatoConsulReq" runat="server" />
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <b>ALQUILER DE EQUIPO MAYORES A TERCEROS </b>
                            </div>
                            <div class="col-md-6">
                                ...
                                <asp:ImageButton ID="btnActualizar" runat="server" ImageUrl="~/imagenes/boton.Arriendos.jpg" OnClick="btnActualizar_Click" ToolTip="Ir a bandeja de arriendos" Visible="False" />
                                <asp:ImageButton ID="btnAmpliacion" runat="server" OnClick="btnAmpliacion_Click" ImageUrl="~/imagenes/boton.ampliacion.jpg" ToolTip="Ir a bandeja de ampliaciones" />
                                <asp:Button ID="btnConsulta" runat="server" Text="consulta" OnClick="btnConsulta_Click"  style="display:none;"/>
                            </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <label>Año</label>
                    <asp:DropDownList ID="ddlanio" runat="server" CssClass="ddl" AutoPostBack="True" OnSelectedIndexChanged="ddlanio_SelectedIndexChanged1"></asp:DropDownList>
                </div>
                <div class="col-md-2">
                    <label>Estados</label>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered table-condensed"
                        AutoGenerateColumns="False" DataKeyNames="Requ_Numero,Reqd_CodLinea,Reqs_Correlativo,D_SOLPED,Reqs_CtdReservada,D_FLG_APRUEBA_CGO,CANTIDAD_LEGAJO,Reqs_ItemSecuencia"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Requerimientos" SortExpression="Requerimientos">
                                <HeaderTemplate>
                                    <asp:ImageButton ID="btnAsignar" runat="server" ImageUrl="~/imagenes/pencil_add.ico" ToolTip="Asignar responsable" OnClick="btnAsignar_Click" />
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="CheckAsignar" runat="server" Text='<%# Bind("Reqs_CodigoCompleto") %>'/>
                            ...
                            <asp:TemplateField HeaderText="descripcion_alquiler" SortExpression="descripcion_alquiler">
                                <HeaderTemplate>
                                    <asp:Label ID="Label23" runat="server" Text="Descripción Req. adicionales" Width="150px"></asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Observaciones" SortExpression="Observaciones">
                                <HeaderTemplate>
                                    <asp:Label ID="Label9" runat="server" Text="Observaciones" Width="150px"></asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="FAMILIA" SortExpression="FAMILIA">
                                <HeaderTemplate>
                                    <asp:Label ID="Label2" runat="server" Text="Familia" Width="150px"></asp:Label>
                                    <asp:TextBox ID="txtFamilia_H" runat="server" Width="150px"></asp:TextBox>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="D_DOCUMENTO_SOLICITA" HeaderText="Fecha Generada" SortExpression="D_DOCUMENTO_SOLICITA"></asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Adjunto OR">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink21" runat="server" ImageUrl="~/imagenes/adjuntar32x32.png" NavigateUrl='<%#Eval("URL") %>' Target="_blank" Visible='<%# (Convert.ToBoolean(Eval("GUIA_SOLPED") )) %>' onerror="this.src='http://app.ssk.com.pe/SIGSSK/imagenes/error-404.png';"></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Regularizacion" >
                                <HeaderTemplate>
                                    <p>Regularización</p>
                                    <asp:ImageButton ID="btnReg" runat="server" ImageUrl="~/imagenes/boton.guardar.gif" OnClick="btnReg_Click" />
                                    <cc1:ConfirmButtonExtender ID="cbe1" runat="server" DisplayModalPopupID="mpe1" TargetControlID="btnReg"></cc1:ConfirmButtonExtender>
                                    <cc1:ModalPopupExtender ID="mpe1" runat="server" PopupControlID="pnlPopup1" TargetControlID="btnReg"
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkSelect" runat="server" Enabled='<%# (Convert.ToBoolean(Eval("PROCESO_BOTON") )) %>' Checked='<%# (Convert.ToBoolean(Eval("FLG_ATENCION_TIPO") )) %>' ToolTip="Regularización de equipo"/>
                                </ItemTemplate>
                               <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>


                            <asp:TemplateField HeaderText="Registrar Solicitud">

                                <ItemTemplate>
                                    <asp:ImageButton ID="btnSelect" runat="server" CommandArgument='<%# Eval("RowNumber") %>' ImageUrl="~/imagenes/pencil_add.ico" OnClick="Seleccionar" Visible='<%# (Convert.ToBoolean(Eval("PROCESO_BOTON") )) %>' CausesValidation="false" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Cantidad adjuntos">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" runat="server" Text='<%# Eval("CANTIDAD_LEGAJO") %>' OnClick="VerLegajos"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="operario" HeaderText="Operario" SortExpression="operario">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="D_DOCUMENTO_FECHA" HeaderText="F.Pre-Legajo" SortExpression="D_DOCUMENTO_FECHA">
                                <HeaderStyle ForeColor="White" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="Solicitar Solped Regularización">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnSOLPED" runat="server" CommandArgument='<%# Eval("RowNumber") %>' ImageUrl='<%# (Eval("IMG_LEGAJO") ) %>' OnClick="EnviarSAP" Visible='<%# (Convert.ToBoolean(Eval("PROCESO_BOTON") )) %>' />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Registrar SOLPED">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnSAP" runat="server" ImageUrl="~/imagenes/table_edit.ico" OnClick="SOLPED" Visible='<%# (Convert.ToBoolean(Eval("PROCESO_BOTON") )) %>' />
...
<asp:BoundField DataField="N_Reqs_Capacidad" HeaderText="Capacidad" SortExpression="N_Reqs_Capacidad" />
                            <asp:TemplateField HeaderText="Solicitar PDC">

                                <ItemTemplate>
                                    <asp:ImageButton ID="btnLegajo" runat="server" CommandArgument='<%# Eval("RowNumber") %>' ImageUrl='<%# (Eval("IMG_PDC") ) %>' OnClick="EnviarSOL_PDC" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Registrar Control">

                                <ItemTemplate>
                                    <asp:ImageButton ID="btnSelectPDC" runat="server" CommandArgument='<%# Eval("RowNumber") %>' ImageUrl="~/imagenes/pencil_add.ico" OnClick="SeleccionarPDC" Visible='<%# (Convert.ToBoolean(Eval("PROCESO_BOTON") )) %>' />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Registro">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnobra" runat="server" CommandArgument='<%# Eval("RowNumber") %>' ImageUrl="~/imagenes/pencil_add.ico" OnClick="SeleccionarObra" Visible='<%# (Convert.ToBoolean(Eval("PROCESO_BOTON") )) %>' />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            ...
                            <asp:BoundField DataField="FECHA_DESPACHO" HeaderText="F.Despacho" SortExpression="FECHA_DESPACHO">
                                <HeaderStyle ForeColor="White" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="F.SalidaProyecto">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtSalida" runat="server"  Text='<%# Bind("D_FECHA_SALIDA", "{0:yyyy-MM-dd}") %>'  Width="130px" TextMode="Date"  onkeypress="return event.keyCode!=13"></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Guardar">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnSave" runat="server" CommandArgument='<%# Eval("RowNumber") %>' ImageUrl="~/imagenes/Save_16x16.ico" OnClick="GuardarSalida" Visible='<%# (Convert.ToBoolean(Eval("PROCESO_SALIDA") )) %>' />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="RESPONSABLE_CARE" HeaderText="Responsable" SortExpression="RESPONSABLE_CARE" />
                            <asp:BoundField DataField="FLG_AMPLIACION" HeaderText="Ampliacion" SortExpression="FLG_AMPLIACION" />
                        </Columns>
            ...
            <asp:GridView ID="gvExcel" runat="server" CssClass="mGridAzul" AutoGenerateColumns="False" DataKeyNames="Requ_Numero,Reqd_CodLinea,Reqs_Correlativo,Reqs_CtdReservada" EmptyDataText="There are no data records to display." Font-Size="8pt"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Reqs_CodigoCompleto" HeaderText="Requerimientos" SortExpression="Reqs_CodigoCompleto"></asp:BoundField>

                    <asp:BoundField DataField="Subf_Descripcion" HeaderText="SubFamilia" SortExpression="Subf_Descripcion"></asp:BoundField>


                    <asp:BoundField DataField="Marc_Descripcion" HeaderText="Marca" SortExpression="Marc_Descripcion"></asp:BoundField>

                    <asp:BoundField DataField="Mode_Descripcion" HeaderText="Modelo" SortExpression="Mode_Descripcion"></asp:BoundField>

                    <asp:BoundField DataField="Equi_Capacidad" HeaderText="Capacidad" SortExpression="Equi_Capacidad"></asp:BoundField>

                    <asp:BoundField DataField="descripcion_alquiler" HeaderText="descripcion alquiler" SortExpression="descripcion_alquiler"></asp:BoundField>

                    <asp:BoundField DataField="Reqd_Observaciones" HeaderText="Observaciones" SortExpression="Reqd_Observaciones"></asp:BoundField>

                    <asp:BoundField DataField="Fami_Descripcion" HeaderText="Familia" SortExpression="Fami_Descripcion"></asp:BoundField>
                    ...
                    <asp:BoundField DataField="SOLPED_SIG" HeaderText="Codigo OR" SortExpression="SOLPED_SIG">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="NOMBRE_SOLICITANTE" HeaderText="Solicitante OR" SortExpression="NOMBRE_SOLICITANTE">
                        <HeaderStyle ForeColor="White" />
...
<asp:BoundField DataField="A_PLACA" HeaderText="Placa" SortExpression="A_PLACA" />
                    ...
                    <asp:BoundField DataField="ORIGEN" HeaderText="TipoBien" SortExpression="ORIGEN" />
                     <asp:BoundField DataField="RESPONSABLE_CARE" HeaderText="Responsable" SortExpression="RESPONSABLE_CARE" />
