<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MasterPopup.master" AutoEventWireup="true" CodeFile="UpdateEquipo.aspx.cs" Inherits="CAREMENOR_UpdateEquipo" %>
                ...
                <asp:GridView ID="GridReq" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" DataKeyNames="Requ_Numero,Reqd_CodLinea,Reqs_Correlativo" OnRowDataBound="GridReq_RowDataBound" OnRowCreated="GridReq_RowCreated">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Pos.Alq.">
                            <ItemTemplate>
                                <asp:TextBox ID="txtPosAlquiler" runat="server" Text='<%# Eval("D_SOLPED_ALQUILER") %>' Enabled="False"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Pos.Mov.">
                            <ItemTemplate>
                                <asp:TextBox ID="txtPosMov" runat="server" Text='<%# Eval("D_SOLPED_MOVIMIENTO") %>' Enabled="False"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
