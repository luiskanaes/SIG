<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdminPopup.master" AutoEventWireup="true" CodeFile="BandejaAmpliacion.aspx.cs" Inherits="CAREMENOR_BandejaAmpliacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    function PopupAmpliacion(ancho, alto) {
        ...
        var win = window.open("AmpliacionEquipo.aspx", "Page Title", "width=" + ancho + ",height=" + alto + ",menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left=" + posicion_x + ",top=" + posicion_y + "");
        var win_timer = setInterval(function () {
            if (win.closed) {
                var boton = document.getElementById('<%=btnBuscar.ClientID%>');
                boton.click();
        ...
        <ContentTemplate>
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <b>AMPLIACION DE EQUIPO MAYORES A TERCEROS </b>
                            </div>
                            <div class="col-md-6">
                                ...
                                <asp:ImageButton ID="btnActualizar" runat="server" ImageUrl="~/imagenes/boton.Arriendos.jpg" OnClick="btnActualizar_Click" ToolTip="Ir a bandeja de arriendos" />
                                <asp:ImageButton ID="btnAmpliacion" runat="server" OnClick="btnAmpliacion_Click" ImageUrl="~/imagenes/boton.agregar.gif" ToolTip="Agregar ampliaciones" />
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <asp:DropDownList ID="ddlEstado" runat="server" CssClass="ddl" AutoPostBack="True" OnSelectedIndexChanged="ddlEstado_SelectedIndexChanged" Visible="False"></asp:DropDownList>
                </div>
