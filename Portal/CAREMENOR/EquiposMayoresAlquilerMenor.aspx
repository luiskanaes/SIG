<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdminPopup.master" AutoEventWireup="true" CodeFile="EquiposMayoresAlquilerMenor.aspx.cs" Inherits="CAREMENOR_EquiposMayoresAlquilerMenor" %>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <asp:ImageButton ID="btnImprimir" runat="server" ImageUrl="~/imagenes/boton.Excel.jpg" OnClick="btnImprimir_Click" />
                                <asp:ImageButton ID="btnActualizar" runat="server" ImageUrl="~/imagenes/boton.actualizarRefresh.jpg" OnClick="btnActualizar_Click" Visible="False" />
                            ...
                            <Columns>
                               ...
                               <%-- <asp:BoundField DataField="D_COSTO_HORA" HeaderText="CostoxHora" SortExpression="D_COSTO_HORA">
                                ...
                                <asp:TemplateField HeaderText="SUBFAMILIA" SortExpression="SUBFAMILIA">
                                    <HeaderTemplate>
                                        ...
                                        <asp:TextBox ID="txtSUBFAMILIA_H" runat="server" Width="130px" onkeypress="return event.keyCode!=13" ></asp:TextBox>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="FAMILIA" SortExpression="FAMILIA">
                                    <HeaderTemplate>
                                        ...
                                        <asp:TextBox ID="txtFamilia_H" runat="server" Width="150px" onkeypress="return event.keyCode!=13"></asp:TextBox>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <HeaderTemplate>
                                    ...
                                    <asp:TextBox ID="txtOR_H" runat="server" Width="100px" onkeypress="return event.keyCode!=13"></asp:TextBox>
                                </HeaderTemplate>
                                <ItemTemplate>
                               ...
                               <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                ...
                                <asp:TemplateField HeaderText="GPO_LEGAJO" SortExpression="GPO_LEGAJO">
                                    <HeaderTemplate>
                                        <asp:Label ID="Label61" runat="server" Text="Grupo Legajo" Width="80px" AutoPostBack="true" OnTextChanged="txtGPO_H_TextChanged"></asp:Label>
                                        <asp:TextBox ID="txtGPO_H" runat="server" Width="80px" onkeypress="return event.keyCode!=13"></asp:TextBox>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="SOLPED" SortExpression="SOLPED">
                                    <HeaderTemplate>
                                        ...
                                        <asp:TextBox ID="txtSOLPED_H" runat="server" Width="90px" onkeypress="return event.keyCode!=13"></asp:TextBox>
                                    </HeaderTemplate>
                                    <ItemTemplate>
