...
public partial class OPERACIONES_RptStatusReq : System.Web.UI.Page
{
    ...
    protected void rpt_cuadro()
    {
        ...
        if (dsCustomers.Rows.Count > 0)
        {
            ...
            rep.ReportPath = Server.MapPath("~/OPERACIONES/Reportes/RptStatusReq.rdlc");
            ...
            {
                CENTRO_COSTO = "REQUERIMIENTOS_SAT";
            }
