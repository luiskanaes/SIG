<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdminPopup.master" AutoEventWireup="true" CodeFile="Andamios.aspx.cs" Inherits="OPERACIONES_Andamios" %>
            ...
            <div class="col-md-4">
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="panelCuadro">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label>Area</label>
                            <asp:DropDownList ID="ddlarea" runat="server" CssClass="ddl"></asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:DropDownList ID="ddlSolicitud" runat="server" CssClass="ddl"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:DropDownList ID="ddlespecialidad" runat="server" CssClass="ddl"></asp:DropDownList>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <asp:DropDownList ID="ddlEstados" runat="server" CssClass="ddl" AutoPostBack="True" OnSelectedIndexChanged="ddlEstados_SelectedIndexChanged">
                        ...
                        <asp:ListItem Value="3">TERMINADO</asp:ListItem>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="IDE_ANDAMIOS" EmptyDataText="There are no data records to display." Font-Size="8pt"  AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="20" OnRowCreated="GridView1_RowCreated" >
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Prioridad">
                                                <ItemTemplate>
                                                    <cemter>
                                                         ...
                                                         <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("IDE_ANDAMIOS") %>' Text='<%# Eval("PRIORIDAD") %>'></asp:LinkButton>
                                                    </cemter>
                                            ...
                                            <asp:BoundField DataField="SUPERVIDOR" HeaderText="Supervisor" SortExpression="SUPERVIDOR" />
                                            <asp:BoundField DataField="CAPATAZ" HeaderText="Capataz" SortExpression="CAPATAZ" />
