...
public partial class OPERACIONES_UrlMaster : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string Reqs_Regularizar = Request.QueryString["Reqs_Regularizar"];
        ...
        if (correo == true)
        {
            ...
            if (dtResultado.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    Response.Redirect("~/CAREMENOR/RegularizacionEquipo.aspx?Requ_Numero=" + Requ_Numero.Trim() + "&Reqd_CodLinea=" + Reqd_CodLinea.Trim() + "&Reqs_Correlativo=" + Reqs_Correlativo + "&Reqs_Regularizar=" + Reqs_Regularizar);
                    //Response.Redirect("~/CAREMENOR/RegularizacionEquipo.aspx?Requ_Numero='" + Requ_Numero.Trim() + "'&Reqd_CodLinea='" + Reqd_CodLinea.Trim() + "'&Reqs_Correlativo='" + Reqs_Correlativo + "'");
                }
            }
            else
            {
