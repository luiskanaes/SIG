...
public partial class Reporte_MOD_detallado : System.Web.UI.Page
{
    ...
    protected void DescargarExcel()
    {
        ...
        if (CheckProyectos.SelectedIndex != -1)
        {
            ...
            ExcelHelper.ToExcel(ds, "REPORTE_MOD_X_OBRERO_ELEMENTO_PEP" + ddlAnio.SelectedValue + "_" + ddlMes.SelectedItem + ".xls", Page.Response);
    ...
    private DataTable GetData_HH_MOD(string proyecto)
    {
        ...
        cmd2.Parameters.Add("@P_VER_HOMOLOGADO", SqlDbType.VarChar).Value = "0";
