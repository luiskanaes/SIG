<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdmin.master" AutoEventWireup="true" CodeFile="Reporte_MOD_detallado.aspx.cs" Inherits="Reporte_MOD_detallado" %>
    ...
    <script type="text/javascript" src="../js/jsUpdateProgress.js"></script>
            ...
            <table style="width:100%" class="">
                <tr>
                    ...
                    <td class="headerText">
                        REPORTE MANO DE OBRA DIRECTA DETALLADO&nbsp;</td>
                    <td style="width: 50px; text-align: center">
                    </td>
                    <td style="width: 50px; text-align: center">
                        &nbsp;</td>
