<%@ Page Language="C#" MasterPageFile="~/Templates/MPAdmin.master"  AutoEventWireup="true" CodeFile="SeguimientoReporteMOI.aspx.cs" Inherits="RRHH_SeguimientoReporte" %>
                ...
                <tr>
                    <td width="25%">
                     <label class="EtiquetaNegrita">Fecha fin</label>
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtFin" PopupButtonID="ImgBntCalc" Format="dd/MM/yyyy"   /></td>
                    <td width="25%"> 
              ...
              <asp:CheckBox ID="chkTodosCECO" runat="server" AutoPostBack="True" 
                ...
                <tr>
                    ...
                    <td width="25%" align="center" colspan="2" style="width: 50%">
                     <table class="style1">
                            ...
                            onclick="btnConsulta_Click" Text="Consultar" Width="50%" />
                                </td>
                                <td align="center" width="50%">
                                   <asp:Button ID="btnDescarga" runat="server" Text="Descargar" 
                            CssClass="buttonVerde"  Width="50%" onclick="btnDescarga_Click" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                 ...
                 <asp:GridView ID="gvExcel" runat="server" AutoGenerateColumns="False" 
                       ...
                       <%--      <RowStyle CssClass="GrillaRow" />  --%>                  
                            <Columns>
                            <asp:BoundField ItemStyle-Width = "150px" DataField="Row" HeaderText="Nro" 
                                    SortExpression="Row" HeaderStyle-Width="150px"   >
                                ...
                                <asp:BoundField DataField="TIP_MANO" HeaderText="Tipo mano de Obra" 
                                    SortExpression="TIP_MANO" >
                                <ControlStyle BackColor="Yellow" BorderColor="Yellow" Font-Bold="True" 
                                    ForeColor="Yellow" />
                                </asp:BoundField>
                                <asp:BoundField DataField="UBICACION" HeaderText="Ubicación" 
                                    SortExpression="UBICACION" />
