<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdmin.master" AutoEventWireup="true" CodeFile="frmRequerimiento.aspx.cs" Inherits="RRHH_frmMOI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    //document.onselectstart = function () { return false; }
        ...
        function popup(ID_DETALLE_REQUERIMIENTO_PERSONAL, ancho, alto) {
            var posicion_x;
            var posicion_y;
            posicion_x = (screen.width / 2) - (ancho / 2);
            posicion_y = (screen.height / 2) - (alto / 2);

            var win = window.open("AsignarRecurso.aspx?ID_DETALLE_REQUERIMIENTO_PERSONAL=" + ID_DETALLE_REQUERIMIENTO_PERSONAL, "Page Title", "width=" + ancho + ",height=" + alto + ",menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left=" + posicion_x + ",top=" + posicion_y + "");
        ...
        <ContentTemplate>
            ...
            <table style="width:100%" class="">
                <tr>
                    ...
                    <td class="headerText">
                        MANTENIMIENTO DE REQUERIMIENTO MOI</td>
                    ...
                    <cc1:AccordionPane ID="pane2" runat="server">
                        ...
                        <Content>
                            <table class="style1">
                                ...
                                <tr>
                                    <td colspan="4" align="center" style="width: 40%" width="20%">
                            ...
                            <asp:DropDownList ID="ddlCentroB" runat="server" AutoPostBack="True" 
                                ...
                                <tr>
                                    ...
                                    <td width="15%" align="left">
                                        ...
                                        <asp:TextBox ID="txtItemB" runat="server" Width="96%"></asp:TextBox></td>
                            ...
                            <asp:DropDownList ID="ddlCargos" runat="server" AutoPostBack="True" 
                                CssClass="ddl" onselectedindexchanged="ddlCargos_SelectedIndexChanged">
                            </asp:DropDownList>--%>
                                                ...
                                                <td align="center" colspan="4">
                                                    <asp:GridView ID="gridPersonal" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="CANDIDATO_FINALISTA"
                                                                HeaderText="Candidato Finalista" SortExpression="CANDIDATO_FINALISTA" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Anular Requerimiento">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="btnAnularRequerimiento" runat="server"
                                                                        CommandArgument='<%# Eval("ID_DETALLE_REQUERIMIENTO_PERSONAL") %>'
                                                                        ImageUrl='<%# Eval("IMG_ESTADO") %>' OnClick="Anular_REQUERIMIENTO"
                                                                        OnClientClick="return confirm('Desea anular requerimiento?');"
                                                                        ToolTip="Seleccionar" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Eliminar Requerimiento">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="btnEliminarRequerimiento" runat="server"
                                                                        CommandArgument='<%# Eval("ID_DETALLE_REQUERIMIENTO_PERSONAL") %>'
                                                                        ImageUrl="~/imagenes/delete.png" OnClick="Eliminar_REQUERIMIENTO"
                                                                        OnClientClick="return confirm('Desea eliminar requerimiento?');"
                                                                        ToolTip="Seleccionar" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Asignar Recurso">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="btnAsignar" runat="server"
                                                                        CommandArgument='<%# Eval("ID_DETALLE_REQUERIMIENTO_PERSONAL") %>'
                                                                        ImageUrl="~/imagenes/EnviarDoc.png.png" OnClick="AsignarRecursos"
                                                                        Visible='<%# (Convert.ToBoolean(Eval("cartilla") )) %>' />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
                            ...
                            <table class="style1">
                                ...
                                <tr>
                                    ...
                                    <td width="20%" align="left">
                                        <label class="EtiquetaNegrita">Ubicación</label>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <label class="EtiquetaNegrita">Origen Posición</label>
                                        <asp:DropDownList ID="ddlOrigen" runat="server" CssClass="ddl">
                                        </asp:DropDownList></td>

                                    <td width="20%" align="left">
                                        <label class="EtiquetaNegrita">Fecha Aprobación</label>
                                ...
                                <tr>
                                    <td width="15%">&nbsp;</td>
                                    <td align="center" colspan="3" style="width: 40%"></td>
                                    <td width="20%">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td colspan="5" style="width: 40%" width="20%" align="center">
                                        <asp:Button ID="btnRegistrar" runat="server"
                                            Text="Registrar"  OnClick="btnRegistrar_Click" /></td>
                                </tr>
                            </table>
                        </Content>
                    </cc1:AccordionPane>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" colspan="2" style="width: 80%" width="40%">
                                            <asp:Button ID="btnBuscarModal" runat="server" CssClass="buttonNegro" 
                                                onclick="btnBuscarModal_Click" Text="Buscar" Visible="true" Width="30%" />
                                        </td>
                                        <td width="10%">
                                            &nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                      ...
                                      <%--  <td align="right" width="40%">
                                            <asp:Button ID="btnNo" runat="server" CssClass="buttonRojo" 
                                                onclick="btnNo_Click" Text="Cancelar" Width="30%" />
                                        </td>--%>
                                        <td width="10%">
                                            &nbsp;</td>
                                    </tr>
