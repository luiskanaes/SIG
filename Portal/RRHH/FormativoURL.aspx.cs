...
public partial class RRHH_FormativoURL : System.Web.UI.Page
{
    string IDE_FORMATIVO;
    string ESTADO;
    protected void Page_Load(object sender, EventArgs e)
    {
        lblCorreo.Text = Request.QueryString["Usuario"];
        IDE_FORMATIVO = Request.QueryString["IDE_FORMATIVO"];
        ESTADO = Request.QueryString["ESTADO"];
        Session["IDE_FORMATIVO"] = Request.QueryString["IDE_FORMATIVO"];
        ...
        if (correo == true)
        {
            ...
            if (dtResultado.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    Response.Redirect("~/RRHH/FormativoProyectoAprobacion.aspx");
                }
            }
            else
            {
        ...
        else
        {
            ...
            else
            {
                ...
                //string url = objUsuario_R.f_UrlDefault_E;
                //Response.Redirect(url);
                Response.Redirect("~/RRHH/ReconocerTalento.aspx");
            }
        }
    }
