...
public partial class RRHH_BravoReporte : System.Web.UI.Page
{
    ...
    protected void rpt_cuadro()
    {
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/RRHH/reporte/RptBravo.rdlc");
    ...
    private DataTable GetData()
    {
        ...
        SqlCommand cmd = new SqlCommand("USP_RPT_BRAVO", con);
