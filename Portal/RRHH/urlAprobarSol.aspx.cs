...
public partial class RRHH_urlAprobarSol : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        lblCorreo.Text = Request.QueryString["ID"];
        hdReq.Value = Request.QueryString["IDE_ASIGNACION"];

        //lblCorreo.Text ="44085236";
        //hdReq.Value = "18";
        ...
        else
        {
            ...
            else
            {
                ...
                Session["IDE_ASIGNACION"] = hdReq.Value;
                Session["IDE_USUARIO"] = objUsuario_R.f_Usuario_E.ToString();
                ...
                //string url = objUsuario_R.f_UrlDefault_E;
                //Response.Redirect(url);
                Response.Redirect("~/RRHH/SolicitudAprobacion.aspx");
            }
        }
    }
