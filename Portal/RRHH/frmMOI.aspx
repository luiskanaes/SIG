<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdmin.master" AutoEventWireup="true" CodeFile="frmMOI.aspx.cs" Inherits="RRHH_frmMOI" %>
         ...
         var ModalProgress = '<%= ModalProgress.ClientID %>';
            ...
            <table style="width:100%" class="">
                ...
                <asp:ImageButton ID="btnSeguimiento" runat="server" CausesValidation="False" 
                        ...
                        onclick="btnSeguimiento_Click" ToolTip="Seguimiento MOI" Width="50px" /></td>
                        ...
                        <td align="center" colspan="5">
                                ...
                                <table class="style1">
                                    <tr>
                                        ...
                                        <td align="left" colspan="2" style="width: 40%" width="20%">
                                            <asp:Label ID="lblIde_MOI" runat="server" Visible="False"></asp:Label>
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%" align="left">
                                            <label class="EtiquetaNegrita">
                                            Ubicación</label>
                                            <asp:DropDownList ID="ddlUbicacion" runat="server" CssClass="ddl">
                                            </asp:DropDownList>
                                        </td>
                                        <td width="20%" align="left">
                                            <label class="EtiquetaNegrita">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" width="20%">
                                            ...
                                            <asp:DropDownList ID="ddlTipoProceso" runat="server" CssClass="ddl">
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left" width="20%">
                                            <label class="EtiquetaNegrita">
                                        ...
                                        <td align="left" width="20%">
                                            <label class="EtiquetaNegrita">
                                            Origen Posición</label>
                                            <asp:DropDownList ID="ddlOrigen" runat="server" CssClass="ddl">
                                            </asp:DropDownList>
                                        </td>
                                        <td width="20%">
                                        &nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%" align="left">
                                            <label class="EtiquetaNegrita">
                                            Detalle Fuente</label>
                                            <asp:TextBox ID="txtFuente" runat="server" Width="95%"></asp:TextBox>
                                        </td>
                                        <td width="20%" align="left">
                                            <label class="EtiquetaNegrita">
                            ...
                            ErrorTooltipEnabled="True" />
                                    ...
                                    <tr>
                                        ...
                                        &nbsp;</td>
                                        <td align="left" width="20%">
                                        <label class="EtiquetaNegrita"> Fecha Primer Envío</label>
                                         <asp:TextBox ID="txtEnvia" runat="server" Width="96%"></asp:TextBox>
                                            <cc1:MaskedEditExtender ID="MaskedEditExtender3" runat="server"
                             TargetControlID="txtEnvia"
                             Mask="99/99/9999"
                             MessageValidatorTip="true"
                             OnFocusCssClass="MaskedEditFocus"
                             OnInvalidCssClass="MaskedEditError"
                             ...
                             AcceptNegative="Left"
                            ErrorTooltipEnabled="True" />
                                            <cc1:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="txtEnvia" PopupButtonID="ImgBntCalc" Format="dd/MM/yyyy"   />
                      
                                        </td>
                                        <td align="left" width="20%">
                                        <label class="EtiquetaNegrita"> Fecha FeedBack</label>
                                            <asp:TextBox ID="txtFeedback" runat="server" Width="96%"></asp:TextBox>
                             ...
                             AcceptNegative="Left"
                            ErrorTooltipEnabled="True" />
                                            <cc1:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="txtFeedback" PopupButtonID="ImgBntCalc" Format="dd/MM/yyyy"   />
                            ...
                            ErrorTooltipEnabled="True" />
                                    ...
                                    <tr>
                                        ...
                                        &nbsp;</td>
                                        <td align="left" width="20%">
                                          <label class="EtiquetaNegrita"> Fecha de inicio de contrato</label>
                            ...
                            ErrorTooltipEnabled="True" />
                                        ...
                                        <td align="left" width="20%">
                                           <label class="EtiquetaNegrita">Fecha de llegada a obra</label>
                                            <asp:TextBox ID="txtIngreso" runat="server" Width="96%"></asp:TextBox>
                                            <cc1:MaskedEditExtender ID="MaskedEditExtender7" runat="server" 
                                                ...
                                                TargetControlID="txtIngreso" />
                                            <cc1:CalendarExtender ID="CalendarExtender7" runat="server" Format="dd/MM/yyyy" 
                                                PopupButtonID="ImgBntCalc" TargetControlID="txtIngreso" />
                                        ...
                                        <td align="center" colspan="3" style="width: 40%">
                                         ...
                                         &nbsp;
                                            <asp:Button ID="btnRegresar" runat="server" CssClass="buttonVerde" 
                                                Text="Regresar" Width="30%" onclick="btnRegresar_Click" onclientclick="window.close();" />
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td align="center" colspan="2" style="width: 80%" width="40%">
                                        <asp:GridView ID="gridPersonal" runat="server" AutoGenerateColumns="False" 
                                            CssClass="mGridAzul" DataKeyNames="DES_DNI,ID_MOI">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Editar">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnSeleccionar" runat="server" 
                                                            CommandArgument='<%# Eval("ID_MOI") %>' ImageUrl="~/imagenes/pencil_add.ico" 
                                                            ToolTip="Seleccionar" OnClick="Seleccionar_MOI"/>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 ...
                                                 <asp:TemplateField HeaderText="Anular">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnAnular" runat="server" 
                                                            CommandArgument='<%# Eval("ID_MOI") %>' ImageUrl="~/imagenes/delete.png" 
                                                            ToolTip="Anular" OnClick="Anular_MOI"/>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
