<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdmin.master" AutoEventWireup="true" CodeFile="FormativoExamen.aspx.cs" Inherits="RRHH_FormativoExamen" %>
                    ...
                    <div class="col-lg- 12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body" style="text-align: justify">
                                ...
                                <asp:RequiredFieldValidator ID="rfvhouse1" runat="server"
                                    ControlToValidate="RadioButtonList1" ErrorMessage="(*) Seleccionar nivel" CssClass ="errorMessage">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body" style="text-align: justify">
                                ...
                                <asp:RequiredFieldValidator ID="rfvhouse" runat="server"
                                    ControlToValidate="RadioButtonList2" ErrorMessage="(*) Seleccionar nivel" CssClass ="errorMessage">
                                </asp:RequiredFieldValidator>
...
<br />
    <div class="row">
        ...
        <div class="col-md-4">
            <center>
            <asp:Button runat="server" Text="Guardar evaluación" ID="btnGuardar" OnClick="btnGuardar_Click"></asp:Button>
            <asp:Button runat="server" Text="Enviar evaluación" ID="btnEnviar" OnClick="btnEnviar_Click" ></asp:Button>
        </center>
        </div>
        <div class="col-md-4">
        </div>
