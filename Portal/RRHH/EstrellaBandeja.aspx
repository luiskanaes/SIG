<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdmin.master" AutoEventWireup="true" CodeFile="EstrellaBandeja.aspx.cs" Inherits="RRHH_EstrellaBandeja" %>
                ...
                <div class="page-container">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <section class="col-md-3">
                                <asp:Label ID="Label3" runat="server" Text="Centros" Font-Bold="True" ></asp:Label>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DES_FACTOR" HeaderText="Competencia" SortExpression="DES_FACTOR" />
                                             ...
                                             <asp:TemplateField HeaderText="Editar">
                                                 <ItemTemplate>
                                                     <asp:ImageButton ID="btnEditar" runat="server" CommandArgument='<%# Eval("IDE_NOMINACION") %>' ImageUrl="~/imagenes/PencilAdd.png" ToolTip="Actualizar" OnClick ="Actualizar_Sustento"  Enabled='<%# (Convert.ToBoolean(Eval("CONTROL") )) %>'/>
