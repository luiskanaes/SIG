<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdmin.master" AutoEventWireup="true" CodeFile="ReconocerBandeja.aspx.cs" Inherits="RRHH_ReconocerBandeja" %>
                        ...
                        <section class="col-md-3">
                         <asp:DropDownList ID="ddlEstados" runat="server" CssClass="ddl" AutoPostBack="True" OnSelectedIndexChanged="ddlEstados_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <section class="col-md-9">
                                <asp:Button ID="btnReconocimiento" runat="server" Text="Reconocimientos" OnClick="btnReconocimiento_Click" CausesValidation="False" />
                            
                                <asp:Button ID="btnProductos" runat="server" Text="Bandeja de premios" OnClick="btnProductos_Click" CausesValidation="False" />

                                 <asp:Button ID="btnCarga" runat="server" Text="Adjuntar recocimientos" OnClick="btnCarga_Click" CausesValidation="False" />
                        ...
                        <div class="row">
                            <div class="col-lg-12 ">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="IDE_COMPETENCIA" EmptyDataText="There are no data records to display." Font-Size="9pt" OnRowDataBound="GridView1_RowDataBound" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="80" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DES_FACTOR" HeaderText="Competencia" SortExpression="DES_FACTOR" />
                                             ...
                                             <asp:TemplateField HeaderText="Puntos">
                                                 <ItemTemplate>
                                                     ...
                                                     <asp:RangeValidator ID="rangeValidator1" runat="server" ControlToValidate="txtPunto" MaximumValue="501" MinimumValue="100" ForeColor="Red" ErrorMessage="Fuera de rango (100-500)" />
                                                 </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Editar">
                                                 <ItemTemplate>
                                                     <asp:ImageButton ID="btnEditar" runat="server" CommandArgument='<%# Eval("IDE_COMPETENCIA") %>' ImageUrl="~/imagenes/PencilAdd.png" ToolTip="Actualizar" OnClick ="Actualizar_Sustento"  Enabled='<%# (Convert.ToBoolean(Eval("CONTROL") )) %>' CausesValidation="false"  />
                                            ...
                                            <asp:TemplateField HeaderText="Procesar">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="btnProcesar" runat="server" CommandArgument='<%# Eval("IDE_COMPETENCIA") %>' ImageUrl="~/imagenes/SaveIcono.png" ToolTip="Procesar Reconocimiento" OnClick ="ProcesarReconocimiento"  Enabled='<%# (Convert.ToBoolean(Eval("CONTROL") )) %>'/>
