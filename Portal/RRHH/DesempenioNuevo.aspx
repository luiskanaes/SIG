<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/MPAdmin.master" AutoEventWireup="true" CodeFile="DesempenioNuevo.aspx.cs" Inherits="RRHH_DesempenioNuevo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>PERSONAL SIN OBJETIVO ASIGNADOS   <asp:Label ID="lblcantidad" runat="server" Text="0"></asp:Label></b><asp:Label ID="lblCodigo" runat="server" Visible="false"></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 ">
                    <div class="table-responsive">
                        <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="ID_DNI" EmptyDataText="There are no data records to display." Font-Size="9pt" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="50">
                            <Columns>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <label>Gerente</label>
                        <asp:DropDownList ID="ddlGerente" runat="server" CssClass="ddl" AutoPostBack="True"  ></asp:DropDownList>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <label>Jefe directo</label>
                   <asp:DropDownList ID="ddlJefe" runat="server" CssClass="ddl" AutoPostBack="True" ></asp:DropDownList>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
             <label>Comentarios</label>
                    <asp:TextBox ID="txtcomentario" runat="server" Height="100px" MaxLength="850" TextMode="MultiLine" ></asp:TextBox>
        </div>
            ...
            <br />
                    <center>
                        <asp:Button runat="server" Text="Cancelar" ID="btnCancelar" OnClick="btnCancelar_Click" ></asp:Button>
                            <asp:Button runat="server" Text="Inscribir" ID="btnAgregar" OnClick="btnAgregar_Click"></asp:Button>
                        <cc1:ConfirmButtonExtender ID="cbe1" runat="server" DisplayModalPopupID="mpe1" TargetControlID="btnAgregar"></cc1:ConfirmButtonExtender>
<cc1:ModalPopupExtender ID="mpe1" runat="server" PopupControlID="pnlPopup1" TargetControlID="btnAgregar"
